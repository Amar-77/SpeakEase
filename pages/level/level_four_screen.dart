...
class _LevelFourScreenState extends State<LevelFourScreen> with TickerProviderStateMixin {
  ...
  // Updated wordImages to include both static images and Lottie animations related to food
  List<String> wordImages = [
    'assets/Lottie/cake.json',      // Lottie animation for "cat"
    'assets/Lottie/juice.json',      // Lottie animation for "dog"
    'assets/Lottie/apple.json',      // Lottie animation for "car"
    'assets/Lottie/candy.json',      // Lottie animation for "bug"
    'assets/Lottie/pizza.json',       // Static image for "pizza"
  ];

  // Custom gradient colors for each word card (unlocked state)
  List<List<Color>> cardGradientColors = [
    [Color(0xfffdfdfd), Color(0xfffdfdfd)],  // Gradient for "cake"
    [Color(0xfffdfdfd), Color(0xfffdfdfd)],  // Gradient for "juice"
    [Color(0xfffdfdfd), Color(0xfffdfdfd)],  // Gradient for "apple"
    [Color(0xfffdfdfd), Color(0xfffdfdfd)],  // Gradient for "candy"
    [Color(0xfffdfdfd), Color(0xfffdfdfd)],  // Gradient for "pizza"
  ];
  ...
  List<List<Color>> lockedCardGradientColors = [
    [Color(0xff757575), Color(0xff757575)],  // Locked gradient for "cake"
    [Color(0xff757575), Color(0xff757575)],  // Locked gradient for "juice"
    [Color(0xff757575), Color(0xff757575)],  // Locked gradient for "apple"
    [Color(0xff757575), Color(0xff757575)],  // Locked gradient for "candy"
    [Color(0xff757575), Color(0xff757575)],  // Locked gradient for "pizza"
  ];
