...
class _LevelSevenScreenState extends State<LevelSevenScreen> with TickerProviderStateMixin {
  ...
  // Words for Level 7 - Using animal theme
  List<String> words = ['group of people', 'kids exercising', 'flock of pigeons', 'climbing stairs', 'conquer the limits'];
  List<String> wordImages = [
    'assets/Lottie/group.json',      // Lottie animation for "cat"
    'assets/Lottie/exercise.json',      // Lottie animation for "dog"
    'assets/Lottie/pigeons.json',      // Lottie animation for "car"
    'assets/Lottie/climb.json',      // Lottie animation for "bug"
    'assets/Lottie/limit.json',       // Static image for "panda"
  ];
  ...
  List<List<Color>> cardGradientColors = [
    ...
    [Color(0xfffdfdfd), Color(0xfffdfdfd)],  // Gradient for "giraffe"
    [Color(0xfffdfdfd), Color(0xfffdfdfd)],  // Gradient for "penguin"
    [Color(0xfffdfdfd), Color(0xfffdfdfd)],  // Gradient for "panda"
  ];
  ...
  List<List<Color>> lockedCardGradientColors = [
    ...
    [Color(0xff757575), Color(0xff757575)],  // Locked gradient for "giraffe"
    [Color(0xff757575), Color(0xff757575)],  // Locked gradient for "penguin"
    [Color(0xff757575), Color(0xff757575)],  // Locked gradient for "panda"
  ];
  ...
  void _playAnimalSound(String animal) async {
    // Placeholder function - implement with actual audio playback if desired
                ...
                child: Column(
                  children: [
                    ...
                    Row(
                      children: [
                        Text(
                          'Advanced syllables'.toUpperCase(),
                          style: TextStyle(
                            fontFamily: "Impact",
                            fontSize: 40,
                            color: const Color(0xFFFDF57F),
